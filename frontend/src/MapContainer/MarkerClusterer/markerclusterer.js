...
var MarkerClusterer = (function () {
    ...
    Q = e(function (t) {
      ...
      (t.exports = function (t, e, o, s) {
        var a = !!s && !!s.unsafe,
          ...
          l = !!s && !!s.noTargetGet;
        "function" == typeof o &&
          ("string" != typeof e || y(o, "name") || w(o, "name", e),
          (r(o).source = i.join("string" == typeof e ? e : ""))),
          t !== n
            ? (a ? !l && t[e] && (u = !0) : delete t[e],
              u ? (t[e] = o) : w(t, e, o))
            : u
            ? (t[e] = o)
            : O(e, o);
    ...
    Ot = function (t, e) {
      ...
      if ((r = l ? n : c ? n[u] || O(u, {}) : (n[u] || {}).prototype))
        for (i in e) {
          if (
            ((s = e[i]),
            (o = t.noTargetGet ? (a = wt(r, i)) && a.value : r[i]),
            !It(l ? i : u + (c ? "." : "#") + i, t.forced) && void 0 !== o)
          ) {
    ...
    zt = function (t, e) {
      ...
      return (Pt[t] =
        ...
        !i(function () {
          if (n && !o) return !0;
          var t = { length: -1 };
          n ? Lt(t, 1, { enumerable: !0, get: Tt }) : (t[1] = 1),
            r.call(t, s, a);
        }));
    },
    Rt = pt.indexOf,
  ...
  var Dt,
    ...
    Kt = function (t) {
      return (
        y(Vt, t) ||
          (Ut && y(Wt, t) ? (Vt[t] = Wt[t]) : (Vt[t] = Xt("Symbol." + t))),
        Vt[t]
      );
    },
  ...
  Qt
    ...
    : qt &&
      (!(Dt = qt.match(/Edge\/(\d+)/)) || Dt[1] >= 74) &&
      (Dt = qt.match(/Chrome\/(\d+)/)) &&
      (Ht = Dt[1]);
  var te = Ht && +Ht,
    ee = Kt("species"),
    re = function (t) {
      ...
      slice: function (t, e) {
        ...
        if (
          ...
          (r !== Array && !$t(r.prototype))
            ? _(r) && null === (r = r[oe]) && (r = void 0)
            : (r = void 0),
          r === Array || void 0 === r)
        )
          return se.call(o, a, u);
        for (
          n = new (void 0 === r ? Array : r)(ae(u - a, 0)), i = 0;
          a < u;
          a++, i++
        )
          a in o && Ft(n, i, o[a]);
      ...
      splice: function (t, e) {
        ...
        if (
          (0 === h
            ...
            : 1 === h
            ? ((r = 0), (n = l - c))
            : ((r = h - 2), (n = ge(fe(ot(e), 0), l - c))),
          l + r - n > de)
        )
          throw TypeError(_e);
        for (i = ce(u, n), o = 0; o < n; o++)
          (s = c + o) in u && Ft(i, o, u[s]);
        if (((i.length = n), r < n)) {
          for (o = c; o < l - n; o++)
    ...
    Q(
      ...
      function () {
        ...
        return (
          ...
          "/" +
          String(
            void 0 === r && t instanceof RegExp && !("flags" in Ee)
              ? be.call(t)
              : r
          )
        );
  ...
  var Re = function (t) {
    ...
    Be = { left: je(!1), right: je(!0) }.left,
    Ze = At("reduce"),
    Ne = zt("reduce", { 1: 0 });
  Ot(
    { target: "Array", proto: !0, forced: !Ze || !Ne },
    {
      reduce: function (t) {
        return Be(
          this,
  ...
  var $e,
    ...
    Xe =
      ...
      Ge.call($e, "a"),
      Ge.call(Fe, "a"),
      0 !== $e.lastIndex || 0 !== Fe.lastIndex),
    Ke = Ue.UNSUPPORTED_Y || Ue.BROKEN_CARET,
    qe = void 0 !== /()??/.exec("")[1];
  (Xe || qe || Ke) &&
    (We = function (t) {
      var e,
  ...
  var Ye = We;
  Ot({ target: "RegExp", proto: !0, forced: /./.exec !== Ye }, { exec: Ye });
  var Je = Kt("species"),
    Qe = !i(function () {
      var t = /./;
      return (
      ...
      if (
        ...
        var u = /./[o],
          l = r(
            ...
            {
              REPLACE_KEEPS_$0: tr,
              REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: rr,
            }
          ),
          c = l[0],
          h = l[1];
    ...
    sr = { codeAt: or(!1), charAt: or(!0) }.charAt,
    ar = function (t, e, r) {
      return e + (r ? sr(t, e).length : 1);
    },
    ur = function (t, e) {
      var r = t.exec;
    ...
    return [
      ...
      function (t, n) {
        ...
        for (var g = []; ; ) {
          ...
          if (null === d) break;
          if ((g.push(d), !p)) break;
          "" === String(d[0]) && (l.lastIndex = ar(c, at(l.lastIndex), f));
        }
        for (var _, v = "", m = 0, y = 0; y < g.length; y++) {
          d = g[y];
          for (
            var x = String(d[0]),
              S = lr(cr(ot(d.index), c.length), 0),
              M = [],
              b = 1;
            b < d.length;
            b++
          )
            M.push(void 0 === (_ = d[b]) ? _ : String(_));
          var C = d.groups;
          if (h) {
          ...
          function (t, i) {
            ...
            var s = E(t),
              ...
              u = (function (t, e) {
                var r,
                  n = E(t).constructor;
                return void 0 === n || null == (r = E(n)[dr]) ? e : Re(r);
              })(s, RegExp),
              l = s.unicode,
              c =
                (s.ignoreCase ? "i" : "") +
                ...
                (s.unicode ? "u" : "") +
                (yr ? "y" : "g"),
              h = new u(yr ? s : "^(?:" + s.source + ")", c),
              p = void 0 === i ? mr : i >>> 0;
            if (0 === p) return [];
            if (0 === a.length) return null === ur(h, a) ? [a] : [];
            for (var f = 0, g = 0, d = []; g < a.length; ) {
              h.lastIndex = yr ? g : 0;
              var _,
                v = ur(h, yr ? a : a.slice(g));
              if (
                null === v ||
                (_ = vr(at(h.lastIndex + (yr ? 0 : g)), a.length)) === f
              )
                g = ar(a, g, l);
              else {
                if ((d.push(a.slice(f, g)), d.length === p)) return d;
                for (var m = 1; m <= v.length - 1; m++)
                  if ((d.push(v[m]), d.length === p)) return d;
                g = f = _;
              }
            }
      ...
      return (
        ...
        (e.prototype.getLabelDivHtml = function () {
          return (
            ...
            Sr({
              position: "absolute",
              top: Mr(this.anchorText_[0]),
              left: Mr(this.anchorText_[1]),
              color: this.style.textColor,
              "font-size": Mr(this.style.textSize),
              "font-family": this.style.fontFamily,
              "font-weight": this.style.fontWeight,
              "font-style": this.style.fontStyle,
              "text-decoration": this.style.textDecoration,
              "text-align": "center",
              width: Mr(this.style.width),
              "line-height": Mr(this.style.textLineHeight),
            }) +
        ...
        (e.prototype.getImageElementHtml = function () {
          ...
          if (this.cluster_.getMarkerClusterer().getEnableRetinaIcons())
            n = { width: Mr(this.style.width), height: Mr(this.style.height) };
          else {
            var i = [
              -1 * r,
          ...
          var o = Sr(Le({ position: "absolute", top: Mr(r), left: Mr(e) }, n));
          return (
            '<img alt="' +
            this.sums_.text +
    ...
    Cr = (function () {
      function t(t) {
        (this.markerClusterer_ = t),
          ...
          (this.center_ = null),
          (this.bounds_ = null),
          (this.clusterIcon_ = new br(this, this.markerClusterer_.getStyles()));
      }
      return (
  ...
  return (function (t) {
    function e(r, n, i) {
      ...
      return (
        ...
        (o.zoomOnClick_ = Er(o.options, "zoomOnClick", !0)),
        (o.averageCenter_ = Er(o.options, "averageCenter", !1)),
        (o.ignoreHidden_ = Er(o.options, "ignoreHidden", !1)),
        (o.enableRetinaIcons_ = Er(o.options, "enableRetinaIcons", !1)),
    ...
    return (
      ...
      (e.prototype.addToClosestCluster_ = function (t) {
        ...
        r && r.isMarkerInClusterBounds(t)
          ? r.addMarker(t)
          : ((i = new Cr(this)).addMarker(t), this.clusters_.push(i));
      }),
